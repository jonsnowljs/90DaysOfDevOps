...
This repository is a clone from [Mark Cade's repo](https://github.com/MichaelCade/90DaysOfDevOps).
This repository is used to document my journey on getting a better foundational knowledge of DevOps. I will be starting this journey on the 14th April 2022 but the idea is that we take 90 days which just so happens to be April 14th to July 13rd. 
